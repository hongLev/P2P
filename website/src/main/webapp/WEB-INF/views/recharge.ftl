			    	...
			    	<div>
			    		...
			    		<form id="rechargeForm" class="form-horizontal el-recharge-form" action="/recharge_save.do" method="post">
			    			<div class="form-group">
			    				...
			    				<div class="col-sm-10">
			    					<select class="form-control" style="width: 480px;" name="bankinfo_id.id">
			    						<#list banks as bank>
				    						<option value="${bank.id}">
												<script>
													var str="("+SITE_BANK_TYPE_NAME_MAP["${bank.bankName}"]+")${bank.bankNumber}&nbsp&nbsp${bank.bankForkName}";
													document.write(str);
												</script>
											</option>
				    					</#list>
