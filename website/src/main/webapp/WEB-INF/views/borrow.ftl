			...
			<div class="el-borrow-item col-sm-4">
				...
				<div class="el-borrow-item-content">
					...
					<ul>
						...
						<li>
							<#if (userinfo.score < borrowBasicSorce) >
								<a href="/userFile.do">材料认证分数达到${borrowBasicSorce}分</a>
								<span class="glyphicon glyphicon-remove" style="color:red;"></span>
							<#else>
							<span>
								材料认证分数达到${userinfo.score}分<span class="glyphicon glyphicon-ok" style="color:green;">
							</#if>
							</span>
						</li>
						<li>视频认证
					...
					<#if userinfo.isBasicInfo && userinfo.isRealAuth && (userinfo.score >= borrowBasicSorce) && userinfo.isVedioAuth>
