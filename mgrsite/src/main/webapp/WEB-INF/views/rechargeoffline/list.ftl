...
<script type="text/javascript">
	$(function() {
		...
		$(".auditClass").click(function(){
			...
			$("#myModal [name=tradeTime]").html(getLocalTime(data.tradeTime));
		});
					...
					<table class="table">
						...
						<#list pageResult.listData as info>
							<tr>
								...
								<td>
									<script>
										var str="("+SITE_BANK_TYPE_NAME_MAP["${info.bankinfo_id.bankName}"]+")${info.bankinfo_id.bankNumber}${info.bankinfo_id.bankForkName}";
										document.write(str);
									</script>
								</td>
